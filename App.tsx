    ...
    >
      <bottomTabs.Screen
        options={{
          tabBarIcon: ({ focused }) => {
            return focused ? (
              <HomeFilledIcon width={25} height={25} color={'green'} />
            ) : (
              <HomeOutlinedIcon width={25} height={25} />
            );
          },
        }}
        name="Home"
      ...
      <bottomTabs.Screen
        options={{
          tabBarIcon: ({ focused }) => {
            return focused ? (
              <HistoryIconFilled width={30} height={30} />
            ) : (
              <HistoryOutlinedIcon width={30} height={30} />
            );
          },
        }}
        name="History"
      ...
      <bottomTabs.Screen
        options={{
          tabBarIcon: ({ focused }) => {
            return focused ? (
              <SettingsFilledIcon width={25} height={25} />
            ) : (
              <SettingsOutlinedIcon width={25} height={25} />
            );
          },
        }}
        name="Settings"
